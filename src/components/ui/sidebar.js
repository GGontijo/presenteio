...
const SidebarInput = React.forwardRef(({ className, ...props }, ref) => {
    return (_jsx(Input, { ref: ref, "data-sidebar": "input", className: cn("h-8 w-full bg-white shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring dark:bg-neutral-950", className), ...props }));
});
